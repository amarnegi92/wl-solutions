                    ...
                    @foreach ($sea_transport_batches as $batch)
                        <tr id={{ $batch->id }}>
                            ...
                            <td class="batch-status">
                                ...
                                <h5>
                                    <span class="badge badge-info"><?php echo config('shipment.keyStatus.' . $batch->status); ?></span>
                                </h5>
                            ...
                            <td class="text-right">
                                ...
                                <a href="{{ route('transport.delete', ['type' =>'sea' ,'id' => $batch->id, 'sanitized_order_number' => sanitize($batch->order_number)] ) }}" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i>
                                            </a>
