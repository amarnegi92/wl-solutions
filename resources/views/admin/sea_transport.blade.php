                    ...
                    @foreach ($sea_transport_batches as $batch)
                        <tr id={{ $batch->id }}>
                            ...
                            <td class="text-right">
                                ...
                                <a href="{{ route('transport.delete', ['type' =>'sea' ,'id' => $batch->id, 'sanitized_order_number' => slug($batch->order_number)] ) }}" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i>
                                            </a>
